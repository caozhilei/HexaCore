...
exports.createTestMessage = exports.enterpriseRoutingConfig = exports.simplifiedExampleRules = exports.exampleRules = exports.defaultRule = exports.trustBasedRule = exports.intentBasedRule = exports.locationSensitiveRule = exports.accountSpecificRule = exports.businessHoursRule = exports.techSupportRule = exports.pricingInquiryRule = exports.vipCustomerRule = void 0;
exports.demonstrateRoutingMatching = demonstrateRoutingMatching;
/**
 * VIP客户专属路由规则示例
 *
 * 匹配条件：
 ...
 * 简化的示例规则集合（3个核心规则）
 */
exports.simplifiedExampleRules = [
    exports.vipCustomerRule,
    exports.pricingInquiryRule,
    exports.techSupportRule,
    exports.defaultRule
 ...
 * 企业级路由配置示例
 */
exports.enterpriseRoutingConfig = {
    rules: exports.exampleRules,
    settings: {
        enableCaching: true,
        cacheTTL: 3600,
 ...
 * 演示路由匹配过程
 */
async function demonstrateRoutingMatching() {
    console.log('=== 路由规则匹配演示 ===\n');
    // 创建测试消息
    const testMessage = (0, exports.createTestMessage)();
    console.log('测试消息特征:');
    ...
    const hasPricingKeyword = pricingKeywords.some(keyword => testMessage.content.text.includes(keyword));
    ...
    const hasTechKeyword = techKeywords.some(keyword => testMessage.content.text.includes(keyword));
